...
from .general import remove_kb_button
...
register_ikb = InlineKeyboardMarkup().add(
    InlineKeyboardButton('Пройти регистрацию заново ↩️', callback_data='restart_registration')
).add(remove_kb_button)
